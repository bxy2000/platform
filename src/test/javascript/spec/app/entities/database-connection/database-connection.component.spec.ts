...
import { DatabaseConnectionComponent } from 'app/entities/database-connection/database-connection.component';
...
describe('Component Tests', () => {
  describe('DatabaseConnection Management Component', () => {
    let comp: DatabaseConnectionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DatabaseConnectionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new DatabaseConnection(123)],
            headers
          })
        )
      );
      ...
      expect(comp.databaseConnections[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
