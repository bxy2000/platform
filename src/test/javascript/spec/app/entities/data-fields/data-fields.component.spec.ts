...
import { DataFieldsComponent } from 'app/entities/data-fields/data-fields.component';
...
describe('Component Tests', () => {
  describe('DataFields Management Component', () => {
    let comp: DataFieldsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DataFieldsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.dataFields[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
